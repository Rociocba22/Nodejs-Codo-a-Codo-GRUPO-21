...
app.use(
  session({
    secret: process.env.SESSION_SECRET || "Admin123!", // Clave secreta para firmar la sesión
    resave: false,
    ...
    cookie: {
      ...
      maxAge: 60 * 60 * 12 * 1000, // Tiempo de vida de la cookie en milisegundos (1 hora)
    },
  })
);
...
//COMANDO para instalar express-session: npm install express-session
